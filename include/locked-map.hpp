...
template<class KeyType, class DataType>
void
LockedMap<KeyType, DataType>::insert(const KeyType& key, const DataType& value)
{
...
template<class KeyType, class DataType>
DataType
LockedMap<KeyType, DataType>::at(const KeyType& key) 
{
...
template<class KeyType, class DataType>
void
LockedMap<KeyType, DataType>::clear()
{
    donkeycar::concurrency::Lock lock(m_mutex);
...
template<class KeyType, class DataType>
size_t
LockedMap<KeyType, DataType>::size() const
{
    donkeycar::concurrency::Lock lock(m_mutex);
    return m_data.size();
}
template<class KeyType, class DataType>
bool
LockedMap<KeyType, DataType>::empty() const
{
    donkeycar::concurrency::Lock lock(m_mutex);
    return m_data.empty();
}
